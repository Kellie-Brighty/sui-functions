  ...
  apps: [
    {
      ...
      env: {
        ...
        REGISTRY_ID: "0x0",
        OPERATOR_KEY_PATH: "/var/www/runner/keys/operator1.json"
      }
    },
    {
      name: "sui-operator-2",
      ...
      env: {
        ...
        PROTOCOL_TREASURY_ID: "0xa659782f25f332b3e947ef4557cd783ce182df87d0dcc71ad22069e7b8f0d789",
        REGISTRY_ID: "0x0",
        OPERATOR_KEY_PATH: "/var/www/runner/keys/operator2.json"
      }
    },
    {
      name: "sui-operator-3",
      ...
      env: {
        ...
        PROTOCOL_TREASURY_ID: "0xa659782f25f332b3e947ef4557cd783ce182df87d0dcc71ad22069e7b8f0d789",
        REGISTRY_ID: "0x0",
        OPERATOR_KEY_PATH: "/var/www/runner/keys/operator3.json"
      }
    }
  ]
};
